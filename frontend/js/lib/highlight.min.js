...
var hljs = (function () {
      ...
      function f(e, t, i, r) {
        ...
        function b(e, n) {
          return (
            ...
            e.beginScope &&
              (e.beginScope._wrap
                ? (g(S, v.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = ''))
        ...
        function h(e) {
          ...
          O.endScope && O.endScope._wrap
            ...
            : O.endScope && O.endScope._multi
              ...
              : r.skip
                ? (S += n)
                : (r.returnEnd || r.excludeEnd || (S += n), d(), r.excludeEnd && (S = n));
          do {
            (O.scope && A.closeNode(),
          ...
          if (((y = r), 'begin' === r.type))
            return ((e) => {
              ...
              return (
                a.skip
                  ? (S += t)
                  : (a.excludeBegin && (S += t), d(), a.returnBegin || a.excludeBegin || (S = t)),
                b(a, e),
      ...
      (Object.assign(t, {
        ...
        registerLanguage: (e, n) => {
          ...
          try {
            ...
            if ((P("Language definition for '{}' could not be registered.".replace('{}', e)), !s))
              throw n;
            (P(n), (i = c));
          }
          (i.name || (i.name = e),
  ...
  function ve(e) {
    ...
    const _ = [].concat(m, c.contains),
      h = _.concat([{ begin: /(\s*)\(/, end: /\)/, keywords: i, contains: ['self'].concat(_) }]),
      f = {
        className: 'params',
        begin: /(\s*)\(/,
        end: /\)/,
  ...
  var Ue = Object.freeze({
    ...
    grmr_less: (e) => {
      const n = te(e),
        ...
        c = { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: ie.join(' ') },
    ...
    grmr_php: (e) => {
      const n = e.regex,
        ...
        v = {
          ...
          match: [
            /\b/,
            n.concat('(?!fn\\b|function\\b|', _(b).join('\\b|'), '|', _(m).join('\\b|'), '\\b)'),
            a,
            n.concat(c, '*'),
            n.lookahead(/(?=\()/),
          ],
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        N = (e = '') => ({ begin: b(e, /"/), end: b(/"/, e), contains: [E(e), w(e)] }),
        k = {
          className: 'string',
    ...
    grmr_typescript: (e) => {
      ...
      return (
        ...
        c(t, 'use_strict', { className: 'meta', relevance: 10, begin: /^\s*['"]use strict['"]/ }),
